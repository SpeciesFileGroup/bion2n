            ...
            if (resource === 'assertedDistributions') {
                ...
                if (operation === 'get') {
                    ...
                    if (additionalFields.collectingEventsWildcards) {
                        urlParams = setUrlParameters('collecting_events_wildcards[]', additionalFields.collectingEventsWildcards, urlParams);
                    }
                    if (additionalFields.collectorIds) {
                        urlParams = setUrlParameters('collector_id[]', additionalFields.collectorIds, urlParams);
                    }
                    if (additionalFields.geographicAreaId) {
                        urlParams = setUrlParameters('geographic_area_id[]', additionalFields.geographicAreaId, urlParams);
                    }
                    if (additionalFields.otuIds) {
                        urlParams = setUrlParameters('otu_id[]', additionalFields.otuIds, urlParams);
                    }
                ...
                if (operation === 'get') {
                    ...
                    if (additionalFields.biocurationClassIds) {
                        urlParams = setUrlParameters('biocuration_class_ids[]', additionalFields.biocurationClassIds, urlParams);
                    }
                    if (additionalFields.biologicalRelationshipIds) {
                        urlParams = setUrlParameters('biological_relationship_ids[]', additionalFields.biologicalRelationshipIds, urlParams);
                    }
                    if (additionalFields.collectingEventIds) {
                        urlParams = setUrlParameters('collecting_event_ids[]', additionalFields.collectingEventIds, urlParams);
                    }
                    if (additionalFields.collectorIdsOr) {
                        urlParams = setUrlParameters('collector_ids_or[]', additionalFields.collectorIdsOr, urlParams);
                    }
                    if (additionalFields.determinerId) {
                        urlParams = setUrlParameters('determiner_id[]', additionalFields.determinerId, urlParams);
                    }
                    if (additionalFields.determinerIdOr) {
                        urlParams = setUrlParameters('determiner_id_or[]', additionalFields.determinerIdOr, urlParams);
                    }
                    if (additionalFields.geographicAreaIds) {
                        urlParams = setUrlParameters('geographic_area_ids[]', additionalFields.geographicAreaIds, urlParams);
                    }
                    ...
                    if (additionalFields.keywordIdAnd) {
                        urlParams = setUrlParameters('keyword_id_and[]', additionalFields.keywordIdAnd, urlParams);
                    }
                    if (additionalFields.keywordIdOr) {
                        urlParams = setUrlParameters('keyword_id_or[]', additionalFields.keywordIdOr, urlParams);
                    }
                    if (additionalFields.otuIds) {
                        urlParams = setUrlParameters('otu_ids[]', additionalFields.otuIds, urlParams);
                    }
                    if (additionalFields.preparationTypeId) {
                        urlParams = setUrlParameters('preparation_type_id[]', additionalFields.preparationTypeId, urlParams);
                    }
                    const options = {
                        headers: {
                            'Accept': 'application/json',
                ...
                if (operation === 'get') {
                    ...
                    if (additionalFields.identifierObjectId) {
                        urlParams = setUrlParameters('identifier_object_id[]', additionalFields.identifierObjectId, urlParams);
                    }
                ...
                if (operation === 'get') {
                    ...
                    let urlParams = '';
                    if (additionalFields.biocurationClassIds) {
                        urlParams = setUrlParameters('biocuration_class_id[]', additionalFields.biocurationClassIds, urlParams);
                    }
                    if (additionalFields.collectionObjectIds) {
                        urlParams = setUrlParameters('collection_object_id[]', additionalFields.collectionObjectIds, urlParams);
                    }
                    ...
                    if (additionalFields.sledImageIds) {
                        urlParams = setUrlParameters('sled_image_id[]', additionalFields.sledImageIds, urlParams);
                    }
                    if (additionalFields.taxonNameIds) {
                        urlParams = setUrlParameters('taxon_name_id[]', additionalFields.taxonNameIds, urlParams);
                    }
                    const options = {
                        headers: {
                            'Accept': 'application/json',
                ...
                if (operation === 'get') {
                    ...
                    if (additionalFields.noteObjectIds) {
                        urlParams = setUrlParameters('note_object_id[]', additionalFields.noteObjectIds, urlParams);
                    }
                    if (additionalFields.noteObjectTypes) {
                        urlParams = setUrlParameters('note_object_type[]', additionalFields.noteObjectTypes, urlParams);
                    }
                    const options = {
                        headers: {
                            'Accept': 'application/json',
                ...
                if (operation === 'get') {
                    ...
                    if (additionalFields.observationMatrixIds) {
                        urlParams = setUrlParameters('observation_matrix_id[]', additionalFields.observationMatrixIds, urlParams);
                    }
                    const options = {
                        headers: {
                            'Accept': 'application/json',
                ...
                if (operation === 'get') {
                    ...
                    if (additionalFields.assertedDistributionIds) {
                        urlParams = setUrlParameters('asserted_distribution_ids[]', additionalFields.assertedDistributionIds, urlParams);
                    }
                    if (additionalFields.biologicalAssociationIds) {
                        urlParams = setUrlParameters('biological_association_ids[]', additionalFields.biologicalAssociationIds, urlParams);
                    }
                    if (additionalFields.taxonNameClassificationIds) {
                        urlParams = setUrlParameters('taxon_name_classification_ids[]', additionalFields.taxonNameClassificationIds, urlParams);
                    }
                    if (additionalFields.taxonNameIds) {
                        urlParams = setUrlParameters('taxon_name_ids[]', additionalFields.taxonNameIds, urlParams);
                    }
                    if (additionalFields.taxonNameRelationshipsIds) {
                        urlParams = setUrlParameters('taxon_name_relationships_ids[]', additionalFields.taxonNameRelationshipsIds, urlParams);
                    }
                    const options = {
                        headers: {
                            'Accept': 'application/json',
                ...
                if (operation === 'get') {
                    ...
                    if (additionalFields.personWildcard) {
                        urlParams = setUrlParameters('person_wildcard[]', additionalFields.personWildcard, urlParams);
                    }
