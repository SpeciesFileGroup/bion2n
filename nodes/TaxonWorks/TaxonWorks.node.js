...
class TaxonWorks {
		...
		this.description = {
			...
			properties: [
				...
				},
				{
					...
					displayOptions: {
						show: {
							resource: ['assertedDistributions'],
							operation: ['get'],
						},
					},
					options: [
				...
				},
				{
					...
					displayOptions: {
						show: {
							resource: ['biologicalAssociation'],
							operation: ['get'],
						},
					},
					options: [
				...
				},
				{
					...
					options: [
						...
						},
						{
							...
							default: '',
							description:
								'Find if associated collecting event has a geographic area. Ignored if param not present',
						},
						{
							displayName: 'Geographic Area IDs',
							name: 'geographicAreaId',
				...
				},
				{
					...
					options: [
						...
						},
						{
							...
							default: '',
							description:
								'Identifier for the observation object global ID for which the observation was made.',
						},
						{
							displayName: 'OTU ID',
							name: 'otuId',
				...
				},
				{
					...
					displayOptions: {
						show: {
							resource: ['taxonNameClassification'],
							operation: ['get'],
						},
					},
					options: [
						...
						},
						{
							...
							options: [
								...
								},
								{
									name: 'ICN Autonym',
									value:
										'TaxonNameClassification::Icn::EffectivelyPublished::ValidlyPublished::Legitimate::Autonym',
								},
								{
									name: 'ICN Conserved',
									value:
								...
								},
								{
									...
									value:
										'TaxonNameClassification::Icn::EffectivelyPublished::ValidlyPublished::Legitimate::ConservedSpelling',
								},
								{
									name: 'ICN Correct',
									value:
								...
								},
								{
									...
									value:
										'TaxonNameClassification::Icn::EffectivelyPublished::ValidlyPublished::Legitimate::NomenNovum',
								},
								{
									name: 'ICN Nothotaxon',
									value:
										'TaxonNameClassification::Icn::EffectivelyPublished::ValidlyPublished::Legitimate::Nothotaxon',
								},
								{
								...
								},
								{
									...
									value:
										'TaxonNameClassification::Icnp::EffectivelyPublished::ValidlyPublished::Legitimate::NomenNovum',
								},
								{
								...
								},
								{
									...
									value:
										'TaxonNameClassification::Iczn::Unavailable::NomenNudum::ElectronicOnlyPublicationBefore2012',
								},
								{
									name: 'ICZN Electronic Publication Not In PDF Format',
									value:
										'TaxonNameClassification::Iczn::Unavailable::NomenNudum::ElectronicPublicationNotInPdfFormat',
								},
								{
									name: 'ICZN Electronic Publication Not Registered In ZooBank',
									value:
										'TaxonNameClassification::Iczn::Unavailable::NomenNudum::ElectronicPublicationNotRegisteredInZoobank',
								},
								{
									name: 'ICZN Electronic Publication Without ISSN or ISBN',
									value:
										'TaxonNameClassification::Iczn::Unavailable::NomenNudum::ElectronicPublicationWithoutIssnOrIsbn',
								},
								{
				...
				},
				{
					...
					displayOptions: {
						show: {
							resource: ['taxonNameRelationship'],
							operation: ['get'],
						},
					},
					options: [
						...
						},
						{
							...
							options: [
								...
								},
								{
									...
									value:
										'TaxonNameRelationship::Iczn::Invalidating::Homonym::Secondary::Secondary1961',
								},
								{
	...
	async execute() {
		...
		const userCredentials = await this.getCredentials('taxonWorksUserApi');
		const projectCredentials = await this.getCredentials('taxonWorksProjectApi');
			...
			if (resource === 'assertedDistributions') {
				if (operation === 'get') {
					...
					if (additionalFields.otuIds) {
						urlParams = setUrlParameters('otu_id[]', additionalFields.otuIds, urlParams);
					}
					const options = {
						headers: {
					...
					console.log(
						`${host}/api/v1/asserted_distributions?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
				...
				if (operation === 'get') {
					...
					if (additionalFields.biologicalAssociationObjectType) {
						qs.biological_association_object_type =
							additionalFields.biologicalAssociationObjectType;
					}
					if (additionalFields.biologicalAssociationSubjectType) {
						qs.biological_association_subject_type =
							additionalFields.biologicalAssociationSubjectType;
					}
					...
					console.log(
						`${host}/api/v1/biological_associations?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					console.log(
						`${host}/api/v1/citations?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					if (additionalFields.collectingEventsWildcards) {
						urlParams = setUrlParameters(
							...
							additionalFields.collectingEventsWildcards,
							urlParams,
						);
					}
					...
					if (additionalFields.geographicAreaId) {
						urlParams = setUrlParameters(
							'geographic_area_id[]',
							additionalFields.geographicAreaId,
							urlParams,
						);
					}
					if (additionalFields.otuIds) {
					...
					console.log(
						`${host}/api/v1/collecting_events?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					if (additionalFields.biocurationClassIds) {
						urlParams = setUrlParameters(
							...
							additionalFields.biocurationClassIds,
							urlParams,
						);
					}
					if (additionalFields.biologicalRelationshipIds) {
						urlParams = setUrlParameters(
							...
							additionalFields.biologicalRelationshipIds,
							urlParams,
						);
					}
					if (additionalFields.collectingEventIds) {
						urlParams = setUrlParameters(
							...
							additionalFields.collectingEventIds,
							urlParams,
						);
					}
					if (additionalFields.collectorIdsOr) {
						urlParams = setUrlParameters(
							'collector_ids_or[]',
							additionalFields.collectorIdsOr,
							urlParams,
						);
					}
					...
					if (additionalFields.determinerIdOr) {
						urlParams = setUrlParameters(
							'determiner_id_or[]',
							additionalFields.determinerIdOr,
							urlParams,
						);
					}
					if (additionalFields.geographicAreaIds) {
						urlParams = setUrlParameters(
							'geographic_area_ids[]',
							additionalFields.geographicAreaIds,
							urlParams,
						);
					}
					if (additionalFields.isType) {
						urlParams = setUrlParameters('is_type[]', additionalFields.isType, urlParams);
					}
					if (additionalFields.isType) {
						urlParams = setUrlParameters('is_type[]', additionalFields.isType, urlParams);
					}
					...
					if (additionalFields.keywordIdOr) {
						urlParams = setUrlParameters(
							'keyword_id_or[]',
							additionalFields.keywordIdOr,
							urlParams,
						);
					}
					if (additionalFields.otuIds) {
						urlParams = setUrlParameters('otu_ids[]', additionalFields.otuIds, urlParams);
					}
					if (additionalFields.preparationTypeId) {
						urlParams = setUrlParameters(
							'preparation_type_id[]',
							additionalFields.preparationTypeId,
							urlParams,
						);
					}
					const options = {
					...
					console.log(
						`${host}/api/v1/collection_objects${idEndpoint}?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					if (additionalFields.topicIds) {
						urlParams = setUrlParameters('topic_id[]', additionalFields.topicIds, urlParams);
					}
					const options = {
						headers: {
							Accept: 'application/json',
					...
					console.log(
						`${host}/api/v1/contents${idEndpoint}?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					console.log(
						`${host}/api/v1/downloads${endpoint}?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					if (additionalFields.identifierObjectId) {
						urlParams = setUrlParameters(
							...
							additionalFields.identifierObjectId,
							urlParams,
						);
					}
					if (additionalFields.identifierObjectType) {
						urlParams = setUrlParameters(
							...
							additionalFields.identifierObjectType,
							urlParams,
						);
					}
					const options = {
					...
					console.log(
						`${host}/api/v1/identifiers?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					if (additionalFields.collectionObjectIds) {
						urlParams = setUrlParameters(
							...
							additionalFields.collectionObjectIds,
							urlParams,
						);
					}
					if (additionalFields.imageIds) {
						urlParams = setUrlParameters('image_id[]', additionalFields.imageId, urlParams);
					}
					if (additionalFields.keywordIdAnd) {
						urlParams = setUrlParameters(
							'keyword_id_and[]',
					...
					console.log(
						`${host}/api/v1/images${endpointId}?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					if (additionalFields.noteObjectIds) {
						urlParams = setUrlParameters(
							'note_object_id[]',
							additionalFields.noteObjectIds,
							urlParams,
						);
					}
					if (additionalFields.noteObjectTypes) {
						urlParams = setUrlParameters(
							'note_object_type[]',
							additionalFields.noteObjectTypes,
							urlParams,
						);
					}
					const options = {
				...
				if (operation === 'get') {
					...
					if (additionalFields.observationMatrixIds) {
						urlParams = setUrlParameters(
							...
							additionalFields.observationMatrixIds,
							urlParams,
						);
					}
					const options = {
				...
				if (operation === 'get') {
					...
					if (additionalFields.assertedDistributionIds) {
						urlParams = setUrlParameters(
							...
							additionalFields.assertedDistributionIds,
							urlParams,
						);
					}
					if (additionalFields.biologicalAssociationIds) {
						urlParams = setUrlParameters(
							...
							additionalFields.biologicalAssociationIds,
							urlParams,
						);
					}
					if (additionalFields.taxonNameClassificationIds) {
						urlParams = setUrlParameters(
							...
							additionalFields.taxonNameClassificationIds,
							urlParams,
						);
					}
					if (additionalFields.taxonNameIds) {
					...
					if (additionalFields.taxonNameRelationshipsIds) {
						urlParams = setUrlParameters(
							...
							additionalFields.taxonNameRelationshipsIds,
							urlParams,
						);
					}
					const options = {
					...
					console.log(
						`${host}/api/v1/otus?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
					console.log(qs);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				...
				if (operation === 'get') {
					...
					if (additionalFields.personWildcard) {
						urlParams = setUrlParameters(
							'person_wildcard[]',
							additionalFields.personWildcard,
							urlParams,
						);
					}
					if (additionalFields.role) {
						urlParams = setUrlParameters(
							'role[]',
							objectToString(additionalFields.role),
							urlParams,
						);
					}
					const options = {
					...
					console.log(
						`${host}/api/v1/people?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					if (additionalFields.authorIds) {
						urlParams = setUrlParameters('author_id[]', additionalFields.authorIds, urlParams);
					}
					if (additionalFields.ids) {
						urlParams = setUrlParameters('ids[]', additionalFields.ids, urlParams);
					}
					if (additionalFields.keywordIdOr) {
						urlParams = setUrlParameters(
							'keyword_id_or[]',
					...
					if (additionalFields.topicIds) {
						urlParams = setUrlParameters('topic_ids[]', additionalFields.topicIds, urlParams);
					}
					const options = {
						headers: {
							Accept: 'application/json',
					...
					console.log(
						`${host}/api/v1/sources${idEndpoint}?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					if (additionalFields.taxonNameClassificationType) {
						urlParams = setUrlParameters(
							...
							objectToString(additionalFields.taxonNameClassificationType),
							urlParams,
						);
					}
					if (additionalFields.taxonNameClassificationSet) {
						urlParams = setUrlParameters(
							...
							objectToString(additionalFields.taxonNameClassificationSet),
							urlParams,
						);
					}
					const options = {
					...
					console.log(
						`${host}/api/v1/taxon_name_classifications?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					if (additionalFields.objectTaxonNameId) {
						urlParams = setUrlParameters(
							...
							additionalFields.objectTaxonNameId,
							urlParams,
						);
					}
					if (additionalFields.subjectTaxonNameId) {
						urlParams = setUrlParameters(
							...
							additionalFields.subjectTaxonNameId,
							urlParams,
						);
					}
					if (additionalFields.taxonNameId) {
					...
					if (additionalFields.taxonNameRelationshipType) {
						urlParams = setUrlParameters(
							...
							objectToString(additionalFields.taxonNameRelationshipType),
							urlParams,
						);
					}
					const options = {
					...
					console.log(
						`${host}/api/v1/taxon_name_relationships?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
				...
				if (operation === 'get') {
					...
					if (additionalFields.nomenclatureCode) {
						urlParams = setUrlParameters(
							'nomenclature_code[]',
							objectToString(additionalFields.nomenclatureCode),
							urlParams,
						);
					}
					if (additionalFields.taxonNameId) {
					...
					if (additionalFields.taxonNameType) {
						urlParams = setUrlParameters(
							'taxon_name_type[]',
							objectToString(additionalFields.taxonNameType),
							urlParams,
						);
					}
					const options = {
					...
					console.log(
						`${host}/api/v1/taxon_names?token=${userCredentials.token}&project_token=${projectCredentials.projectToken}${urlParams}`,
					);
					responseData = await this.helpers.request(options);
					returnData.push(responseData);
				}
...
exports.TaxonWorks = TaxonWorks;
//# sourceMappingURL=TaxonWorks.node.js.map
