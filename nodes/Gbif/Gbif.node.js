...
exports.Gbif = void 0;
function setUrlParameters(parameter, values, urlParams = '') {
		...
		this.description = {
			...
			properties: [
				...
				},
				{
					...
					default: '',
					description:
						'Unless using the optional datasetKey parameter, use the occurrence key as the ID (e.g., 1039520441). Otherwise with the datasetKey parameter, use the occurrenceID as the ID (e.g., urn:uuid:59ceb2e9-00b5-4fb8-a79b-71d644ae106c, urn:catalog:UAZ:Ornithology:UAz-004647, SANT:SANT-Algae:27907-A, etc.).',
					displayOptions: {
						show: {
							resource: ['occurrence'],
							operation: ['get'],
				...
				},
				{
					...
					options: [
						...
						},
						{
							...
							required: false,
							description:
								'Filters datasets by their temporal coverage broken down to decades. Decades are given as a full year, e.g. 1880, 1960, 2000, etc, and will return datasets wholly contained in the decade as well as those that cover the entire decade or more',
						},
						{
						...
						},
						{
							...
							default: '',
							description:
								'Used in combination with the facet parameter (e.g., set facetMincount=1000 to exclude facets with a count less than 1000)',
						},
						{
							displayName: 'Identifier',
							name: 'identifier',
				...
				},
				{
					...
					options: [
						...
						},
						{
							...
							default: '',
							description:
								'The horizontal distance (in meters) from the given decimalLatitude and decimalLongitude describing the smallest circle containing the whole of the Location (e.g., use "100,200" for an uncertainty of 100 - 200 meters).',
							required: false,
						},
						{
							displayName: 'Country',
						...
						},
						{
							...
							required: false,
							description:
								'Latitude in decimals between -90 and 90 based on spatial reference system WGS84 (e.g., -81.14,-80.79)',
						},
						{
							...
							required: false,
							description:
								'Longitude in decimals between -180 and 180 based on spatial reference system WGS84 (e.g., -160.38,-154.23)',
						},
						{
							displayName: 'Depth',
							name: 'depth',
							...
							required: false,
							description:
								'Depth in meters relative to altitude (e.g., use 10,30 for 10 to 30 meters below a lake surface with given altitude)',
						},
						{
							...
							required: false,
							description:
								'Elevation (altitude) in meters above sea level (e.g., 10000,14000 for an altitude of 10000 to 14000 meters)',
						},
						{
						...
						},
						{
							...
							required: false,
							description:
								'Occurrence date in ISO 8601 format: yyyy, yyyy-MM, yyyy-MM-dd, or MM-dd (e.g., use 2021-01-01 for an exact date or use 2021-01-01,2021-01-31 for a date range)',
						},
						{
						...
						},
						{
							...
							required: false,
							description:
								'Start partial date of a date range in the format of yyyy-MM (e.g., 2015-11)',
						},
						{
							...
							required: false,
							description:
								'A GADM geographic identifier at any level (e.g., AGO, AGO.1_1, AGO.1.1_1 or AGO.1.1.1_1)',
						},
						{
						...
						},
						{
							...
							required: false,
							description:
								'Filters to match occurrence records with coordinate values within a specified distance of a coordinate, it supports units: in, yd, ft, km, mmi, mm, cm, mi, or m (e.g., 90m,100m)',
						},
						{
						...
						},
						{
							...
							required: false,
							description:
								'Limits searches to occurrence records which contain a value in both latitude and longitude (e.g., hasCoordinate=true limits to occurrence records with coordinate values and hasCoordinate=false limits to occurrence records without coordinate values)',
						},
						{
						...
						},
						{
							...
							required: false,
							description:
								'An identifier of any form assigned by the source to identify the institution. Institution codes are not guaranteeed to be unique.',
						},
						{
							displayName: 'Issue',
							name: 'issue',
						...
						},
						{
							...
							required: false,
							description:
								'The date the record was last changed in GBIF in ISO-8601 format: yyyy, yyyy-MM, yyyy-MM-dd, or MM-dd (e.g., 2020,2021 for year range 2020 - 2021), which is not necessarily the date the record was first/last changed by the publisher. Data is re-interpreted when GBIF changes the taxonomic backbone, geographic data sources, or interpretation processes.',
						},
						{
							displayName: 'License',
							name: 'license',
						...
						},
						{
							...
							required: false,
							description:
								'The most recent date-time on which the resource was changed, according to the publisher',
						},
						{
							displayName: 'Month',
							name: 'month',
							...
							required: false,
							description:
								'The month of the year, starting with 1 for January (e.g., 1 for January or 1,4 for January through April)',
						},
						{
							displayName: 'Network Key',
							name: 'networkKey',
						...
						},
						{
							...
							required: false,
							description:
								'A single globally unique identifier for the occurrence record as provided by the publisher',
						},
						{
						...
						},
						{
							...
							required: false,
							description:
								'A group of activities, often associated with a specific funding stream, such as the GBIF BID programme',
						},
						{
							displayName: 'Project ID',
							name: 'projectId',
						...
						},
						{
							...
							required: false,
							description:
								"The 2-letter country code (as per ISO-3166-1) of the publishing organization's country",
						},
						{
							displayName: 'Publishing Organization',
							name: 'publishingOrg',
						...
						},
						{
							...
							required: false,
							description:
								'The relative measurement of the quantity of the organism (e.g., without absolute units)',
						},
						{
							...
							required: false,
							description:
								'Searches for records whose publishing country is different from the country in which it was recorded',
						},
						{
						...
						},
						{
							...
							required: false,
							description:
								'Searches for a scientific name from the GBIF backbone (including synonyms) using the species match service to retrieve a taxonKey. Only unique scientific names will return results, homonyms (including many monomials) will return nothing. Consider using the taxonKey parameter instead and the species match service directly.',
						},
						{
						...
						},
						{
							...
							required: false,
							description:
								'A taxon key from the GBIF backbone, including all children and synonyms of the taxon (e.g., taxonKey=212 will return all species of birds)',
						},
						{
							displayName: 'To Date',
							name: 'toDate',
							...
							required: false,
							description:
								'End partial date of a date range in the format of yyyy-MM (e.g., 2015-11)',
						},
						{
						...
						},
						{
							...
							required: false,
							description:
								'The scientific name provided to GBIF by the data publisher prior to interpretation and processing by GBIF',
						},
						{
						...
						},
						{
							...
							required: false,
							description:
								'The name of the water body in which the Locations occurs (e.g., Lake Michigan)',
						},
						{
							displayName: 'Year',
							name: 'year',
							...
							required: false,
							description:
								'The 4 digit year with 98 interpreted as AD 98 (e.g., 2020,2022 for the year range 2020 through 2022, or 2020 for the exact year 2020)',
						},
					],
				},
				{
					...
					options: [
						...
						},
						{
							...
							default: '',
							description:
								'Filters occurrence counts by country given as a ISO 639-1 (2 letter) country code',
						},
						{
							displayName: 'Dataset Key',
							name: 'datasetKey',
						...
						},
						{
							...
							required: false,
							description:
								'Filters occurrence counts by protocol or mechanism used to provide the occurrence record',
						},
						{
							displayName: 'Publishing Country',
							name: 'publishingCountry',
							...
							default: '',
							description:
								'Filters occurrence counts by publishing country given as a ISO 639-1 (2 letter) country code',
						},
						{
							displayName: 'Taxon Key',
							name: 'taxonKey',
						...
						},
						{
							...
							required: false,
							description:
								'Filters occurence counts by nomenclatural type (type status, typified scientific name, publication) applied to the subject',
							options: [
								{
									name: '',
									value: '',
				...
				},
				{
					...
					options: [
						...
						},
						{
							...
							default: '',
							description:
								'Optional for species match endpoint: kingdom classification accepting a canonical name',
						},
						{
							displayName: 'Phylum',
							name: 'phylum',
							...
							default: '',
							description:
								'Optional for species match endpoint: phylum classification accepting a canonical name',
						},
						{
							displayName: 'Class',
							name: 'class',
							...
							default: '',
							description:
								'Optional for species match endpoint: class classification accepting a canonical name',
						},
						{
							displayName: 'Order',
							name: 'order',
							...
							default: '',
							description:
								'Optional for species match endpoint: order classification accepting a canonical name',
						},
						{
							displayName: 'Family',
							name: 'family',
							...
							default: '',
							description:
								'Optional for species match endpoint: family classification accepting a canonical name',
						},
						{
							displayName: 'Genus',
							name: 'genus',
							...
							default: '',
							description:
								'Optional for species match endpoint: genus classification accepting a canonical name',
						},
					],
				},
				{
					...
					options: [
						...
						},
						{
							...
							default: '',
							description:
								'Filters by any of the higher Linnean rank keys (within the respective checklist and not searching nub keys across all checklists)',
						},
						{
	...
	async execute() {
		...
		for (let i = 0; i < items.length; i++) {
			...
			if (resource === 'collection') {
				if (operation === 'get') {
					const collectionId = this.getNodeParameter('id', i);
					const subResource = this.getNodeParameter('subResource', i);
					const qs = {};
					let idEndpoint = '';
					if (collectionId !== '') {
				...
				if (operation === 'get') {
					const datasetId = this.getNodeParameter('id', i);
					const subResource = this.getNodeParameter('subResource', i);
				...
				if (operation === 'get') {
					const installationId = this.getNodeParameter('id', i);
					const subResource = this.getNodeParameter('subResource', i);
					const qs = {};
					let idEndpoint = '';
					if (installationId !== '') {
				...
				if (operation === 'get') {
					const institutionId = this.getNodeParameter('id', i);
					const subResource = this.getNodeParameter('subResource', i);
					const qs = {};
					let idEndpoint = '';
					if (institutionId !== '') {
				...
				if (operation === 'get') {
					const networkId = this.getNodeParameter('id', i);
					const subResource = this.getNodeParameter('subResource', i);
					const qs = {};
					let idEndpoint = '';
					if (networkId !== '') {
				...
				if (operation === 'get') {
					const nodeId = this.getNodeParameter('id', i);
					const subResource = this.getNodeParameter('subResource', i);
					const qs = {};
					let idEndpoint = '';
					if (nodeId !== '') {
				...
				if (operation === 'get') {
					...
					qs.q = this.getNodeParameter('q', i);
					const options = {
						headers: {
							Accept: 'application/json',
						},
				...
				if (operation === 'get') {
					const taxonId = this.getNodeParameter('id', i);
					const subResource = this.getNodeParameter('subResource', i);
					const additionalFields = this.getNodeParameter('additionalFields', i);
					const qs = {};
					let idEndpoint = '';
					...
					let urlParams = '';
					if (additionalFields.facet) {
						urlParams = setUrlParameters('facet', additionalFields.facet, urlParams);
					}
					if (additionalFields.habitat) {
						urlParams = setUrlParameters('habitat', additionalFields.habitat, urlParams);
					}
					if (additionalFields.issue) {
						urlParams = setUrlParameters('issue', additionalFields.issue, urlParams);
					}
					if (additionalFields.nameType) {
						urlParams = setUrlParameters('nameType', additionalFields.nameType, urlParams);
					}
					if (additionalFields.nomenclaturalStatus) {
						urlParams = setUrlParameters(
							'nomenclaturalStatus',
							additionalFields.nomenclaturalStatus,
							urlParams,
						);
					}
					if (additionalFields.rank) {
						urlParams = setUrlParameters('rank', additionalFields.rank, urlParams);
					}
					if (additionalFields.status) {
						urlParams = setUrlParameters('status', additionalFields.status, urlParams);
					}
					if (additionalFields.threat) {
						urlParams = setUrlParameters('threat', additionalFields.threat, urlParams);
					}
...
exports.Gbif = Gbif;
//# sourceMappingURL=Gbif.node.js.map
