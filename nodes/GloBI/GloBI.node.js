...
class GloBI {
	constructor() {
		this.description = {
			...
			version: 1,
			description:
				'Global Biotic Interactions (GloBI) provides open access to finding species interaction data',
			defaults: {
				name: 'GloBI',
				color: '#007934',
			},
	...
	async execute() {
		...
		for (let i = 0; i < items.length; i++) {
			...
			if (resource === 'interaction') {
				const additionalFields = this.getNodeParameter('additionalFields', i);
				const sourceTaxon = this.getNodeParameter('sourceTaxon', i);
				const interactionType = this.getNodeParameter('interactionType', i);
				const targetTaxon = this.getNodeParameter('targetTaxon', i);
				...
				const sourceTaxon = encodeURIComponent(this.getNodeParameter('sourceTaxon', i));
				const interactionType = encodeURIComponent(this.getNodeParameter('interactionType', i));
				const targetTaxon = encodeURIComponent(this.getNodeParameter('targetTaxon', i));
...
exports.GloBI = GloBI;
//# sourceMappingURL=GloBI.node.js.map
