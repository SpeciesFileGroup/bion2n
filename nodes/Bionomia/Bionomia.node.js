    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            if (resource === 'occurrence') {
                ...
                if (operation === 'get') {
                    const qs = {};
                    const datasetKey = this.getNodeParameter('datasetKey', i);
                    const occurrenceID = this.getNodeParameter('occurrenceID', i);
...
exports.Bionomia = Bionomia;
//# sourceMappingURL=Bionomia.node.js.map